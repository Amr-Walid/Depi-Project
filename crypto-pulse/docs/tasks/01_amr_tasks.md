...
### Task 3.8 — مزامنة البيانات التاريخية وإصلاح تعارض مخطط الأعمدة في PySpark [COMPLETE ✅]

- [x] تشخيص وحل مشكلة تعارض الأعمدة (`close_time`) في PySpark JDBC Writer عن طريق إسقاط الأعمدة غير المتوافقة واختيار الأعمدة الـ 11 المناسبة لجدول `silver.historical` في قاعدة بيانات Supabase.
- [x] إضافة ميزة المزامنة التلقائية للملفات التاريخية JSON بين نظام WSL الافتراضي ومجلد Windows المشترك لضمان تحديث الحاويات بالبيانات الناقصة المجلوبة من الإنترنت فوراً.
- [x] أتمتة تشغيل البايبلاين بالكامل وإدماج كود تشغيل المتصفح التلقائي على صفحة لوحة التحكم (`http://localhost:3000`) بمجرد نجاح إطلاق الخدمات.
- [x] التحقق العملي ومزامنة **37,754 صفاً** تاريخياً ليعرض التشارت البيانات بأمان تام حتى تاريخ اليوم **20 مايو 2026**.
...
| 3.8 | مزامنة البيانات التاريخية وإصلاح مخطط PySpark | Complete ✅ |
