...
## 🏁 Milestone 1 — تأسيس طبقة Gold Layer بـ dbt

**الهدف:** تحويل البيانات النظيفة في Silver Layer إلى جداول تحليلية جاهزة تمامًا للاستخدام في API والتقارير.
...
### ❌ Task 1.3 — بناء نماذج Bronze (Staging)
...
### ❌ Task 1.4 — بناء نماذج Gold (التحليلية)
...
## 🚀 Milestone 2 — جودة البيانات والتوثيق

**الهدف:** ضمان موثوقية البيانات في Gold Layer وتوثيق كل شيء.

---

### ❌ Task 2.1 — كتابة اختبارات جودة البيانات
...
| 1.3 | Staging Models (stg_prices, stg_news) | ❌ لم يبدأ |
| 1.4 | Gold Models (coin_daily_summary, sentiment) | ❌ لم يبدأ |
| 2.1 | اختبارات جودة البيانات | ❌ لم يبدأ |
| 2.2 | توثيق النماذج | ❌ لم يبدأ |
| 2.3 | تكامل dbt مع Airflow DAG | ❌ لم يبدأ |
