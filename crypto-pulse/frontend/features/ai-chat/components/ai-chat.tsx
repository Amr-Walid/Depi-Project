    ...
    <>
      <div className="px-4 py-4 lg:px-6">
        <div className="flex flex-col gap-2">
          <h1 className="text-2xl font-bold tracking-tight">CryptoPulse AI Assistant</h1>
          <p className="text-muted-foreground">
            Get real-time insights, market analysis, and help with your crypto queries.
          </p>
        </div>
      </div>
              ...
              <ConversationContent>
                {messages.length === 0 ? (
                  <ConversationEmptyState
                    ...
                    description="Ask me anything or try asking about a topic you'd like to learn more about."
                    icon={
